...
mov di,0
loopstarsall:
mov word[es:di],		0x812a
mov word[es:di+4],	0x822a
mov word[es:di+8],	0x832a
mov word[es:di+12],	0x842a
mov word[es:di+16],	0x852a
mov word[es:di+20],	0x862a
mov word[es:di+24],	0x872a
mov word[es:di+28],	0x882a
mov word[es:di+32],	0x892a
mov word[es:di+36],	0x8a2a
mov word[es:di+40],	0x8b2a
mov word[es:di+44],	0x8c2a
mov word[es:di+48],	0x8d2a
mov word[es:di+52],	0x8e2a
mov word[es:di+56],	0x8f2a
add di,60
cmp di,4000
jl loopstarsall
